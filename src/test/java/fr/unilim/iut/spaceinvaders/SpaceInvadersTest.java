...
public class SpaceInvadersTest {
	...
	public void test_unNouveauVaisseauEstPositionneHorsEspaceJeuTropAGauche_UneExceptionEstLevee() throws Exception {
		SpaceInvaders spaceinvaders = new SpaceInvaders(15, 10);
		spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(1,1),new Position(-1,0), 1);
	}
	
	@Test(expected = HorsEspaceJeuException.class)
	public void test_unNouveauVaisseauEstPositionneHorsEspaceJeuTropEnHaut_UneExceptionEstLevee() throws Exception {
		SpaceInvaders spaceinvaders = new SpaceInvaders(15, 10);
		spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(1,1),new Position(0,-1), 1);
	}
	...
	public void test_UnNouveauVaisseauPositionneDansEspaceJeuMaisAvecDimensionTropGrande_DoitLeverUneExceptionDeDebordement() {
		...
		try {
			spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(9,2),new Position(9,7), 1);
	...
	@Test
	public void test_unEnvahisseurEstCorrectementPositionneDansEspaceJeu() {
		SpaceInvaders spaceinvaders = new SpaceInvaders(15, 10);
	...
	public void test_UnNouvelEnvahisseurPositionneDansEspaceJeuMaisAvecDimensionTropGrande_DoitLeverUneExceptionDeDebordement() {
		...
		try {
			spaceinvaders.positionnerUnNouvelEnvahisseur(new Dimension(9,2),new Position(9,7), 1);
			fail("Dépassement du vaisseau à droite en raison de sa longueur trop importante : devrait déclencher une exception DebordementEspaceJeuException");
		} catch (final DebordementEspaceJeuException e) {
		}
    ...
    @Test
    public void test_Envahisseur_Avance_DeplacerVaisseauVersLaGauche() {
    ...
    @Test
    public void test_Envahisseur_Immobile_DeplacerEnvahisseurVersLaGauche() {
